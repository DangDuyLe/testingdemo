...
const HomePage = () => {
  ...
  // Fetch data from Neo4j API route
  useEffect(() => {
    fetch('/api/neo4j')
      .then((res) => res.json())
      .then((data) => {
        // Assuming the API returns an object with a "nodes" array
        setNeo4jData(data.nodes);
      })
      .catch((error) => {
  ...
  return (
    <div className="relative font-sans">
      ...
      <div className="relative z-10 bg-transparent">
        ...
        {/* Neo4j Data Section */}
        <div className="container mx-auto px-4 py-12" data-aos="fade-up">
          <h2 className="text-2xl font-bold mb-4">Neo4j Data</h2>
          {neo4jData.length > 0 ? (
            <ul>
              {neo4jData.map((node, index) => (
